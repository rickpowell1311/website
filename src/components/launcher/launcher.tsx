const Tile = ({children = undefined as any}) => {
    return (
        <div className="border-slate-400 border-solid border-2 rounded-3xl w-32 h-32 bg-slate-500 hover:scale-110 duration-300 hover:border-slate-200 cursor-pointer hover:shadow-lg hover:drop">
